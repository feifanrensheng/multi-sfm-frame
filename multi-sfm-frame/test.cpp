...
void match_current_frame(Mat& frame, Mat& train_descriptors, vector<Point3f>& structure, Mat& K, Mat& R, Mat& T)
{
	...
	cout<<knn_matches[0][0].distance<<" "<<knn_matches[0][1].distance<<endl;
	cout<<knn_matches[1][0].distance<<" "<<knn_matches[1][1].distance<<endl;
	cout<<knn_matches[2][0].distance<<" "<<knn_matches[2][1].distance<<endl;
	cout<<knn_matches[3][0].distance<<" "<<knn_matches[3][1].distance<<endl;
...
int main(int argc, char** argv)
{
	...
	cout<<train_descriptors.cols<<"  "<<train_descriptors.rows<<endl;
	cout<<structure.size()<<endl;

	Mat frame = imread("../0010.png");
	Mat R_C, T_C;
	match_current_frame(frame, train_descriptors, structure, K, R_C, T_C);
